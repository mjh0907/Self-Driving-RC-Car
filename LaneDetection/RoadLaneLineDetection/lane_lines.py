...
def filter_colors(image):
    ...
    lower_yellow = np.array([5,120,120])
...
def annotate_image_array(image_in):
    ...
    cv2.imshow("before filter color", image_in)
    image = filter_colors(image_in)
    
    cv2.imshow("after filter color", image)
